...
function Form() {
  ...
  // Editing any field invalidates whatever the last attempt complained about,
  // so clear the server error as soon as the user types.
  ...
  // Derived, not stored: the mismatch warning appears and disappears live as the
  // password fields change instead of lingering from an earlier submit.
